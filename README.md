...
Esta carpeta es un proyecto de Vercel (no un simple HTML suelto): incluye dos
funciones de servidor (`/api/alumni` y `/api/proximo-curso`) que leen
directamente de tu Blob Store `globalcrew` para rellenar:
